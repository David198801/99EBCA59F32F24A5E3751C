...
transRaster = ((arcpy.Raster(inPath + "trans40")*2) > arcpy.Raster(inPath + "transcycle"))
greenRaster = arcpy.Raster(inPath + "green")
waterRaster = arcpy.Raster(inPath + "water")
greenRaster2 = arcpy.Raster(inPath + "green2")

transRaster.save(inPath+"trans40ltc")

slopeRaster = arcpy.Raster("D:/paddy/3 DEM2018/less6_reclass")

paddyRaster = (paddyMayRaster == 1) & (transRaster == 1) & (greenRaster == 0) & (waterRaster == 0) & (slopeRaster == 1) & (greenRaster2 == 0)
