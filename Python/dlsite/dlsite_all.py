...
for page_num in range(1, all_page_num + 1):
    ...
    while True:
        try:
            ...
            searchDivLableList = soup.find_all(name='div', class_="multiline_truncate")
    ...
    for searchDivLable in searchDivLableList:
        workALableList = searchDivLable.find_all(name='a')
        rjCode = workALableList[0]["href"].replace(".html","").split("/")[-1]
        rj_set.add(rjCode)
