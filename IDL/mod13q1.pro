PRO MOD13Q1
  ...
  FOR i=0, N_ELEMENTS(files)-1 DO BEGIN
    ...
    IF i MOD 4 EQ 3 THEN BEGIN
      ...
      newFile = "D:/paddy/MOD13Q1/2000/"+STRMID(files[i], 9, 7)+"_"+STRMID(files[i], 31, 7) + ".tif"
      mosaicRaster.Export, newFile, 'ENVI' ;, DATA_IGNORE_VALUE=-3000
      print , newFile
